...
//  ********** Library ElementRectExample **************
// ********** Code for ElementRectExample **************
function ElementRectExample() {

}
ElementRectExample.prototype.run = function() {
  var $this = this; // closure support
  get$$document().get$body().get$rect().then((function (rect) {
    $this.write("document.body.rect offset");
    $this.write(("width = " + rect.offset.width));
    $this.write(("height = " + rect.offset.height));
    $this.write(("left = " + rect.offset.left));
    $this.write(("right = " + rect.offset.get$right()));
    $this.write(("top = " + rect.offset.top));
    $this.write(("bottom = " + rect.offset.get$bottom()));
    $this.write(("toString = " + rect.offset.toString()));
    $this.write("");
    $this.write("document.body.rect client");
    $this.write(("width = " + rect.client.width));
    $this.write(("height = " + rect.client.height));
    $this.write(("left = " + rect.client.left));
    $this.write(("right = " + rect.client.get$right()));
    $this.write(("top = " + rect.client.top));
    $this.write(("bottom = " + rect.client.get$bottom()));
    $this.write(("toString = " + rect.client.toString()));
    $this.write("");
    $this.write("document.body.rect bounding");
    $this.write(("width = " + rect.get$bounding().get$width()));
    $this.write(("height = " + rect.get$bounding().get$height()));
    $this.write(("left = " + rect.get$bounding().get$left()));
    $this.write(("right = " + rect.get$bounding().get$right()));
    $this.write(("top = " + rect.get$bounding().get$top()));
    $this.write(("bottom = " + rect.get$bounding().get$bottom()));
    $this.write(("toString = " + rect.get$bounding().toString()));
    $this.write("");
    $this.write("document.body.rect scroll");
    $this.write(("width = " + rect.scroll.width));
    $this.write(("height = " + rect.scroll.height));
    $this.write(("left = " + rect.scroll.left));
    $this.write(("right = " + rect.scroll.get$right()));
    $this.write(("top = " + rect.scroll.top));
    $this.write(("bottom = " + rect.scroll.get$bottom()));
    $this.write(("toString = " + rect.scroll.toString()));
  })
  );
}
ElementRectExample.prototype.write = function(message) {
  get$$document().query("#status").set$innerHTML(("" + get$$document().query("#status").get$innerHTML() + " <br/> " + message));
}
// ********** Code for top level **************
function main() {
